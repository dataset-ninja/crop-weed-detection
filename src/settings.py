...
PREVIEW_IMAGE_ID: int = 1672453
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/crop-weed-detection"
...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/ravirajsinh45/crop-and-weed-detection-data-with-bounding-boxes/download?datasetVersionNumber=1"
...
AUTHORS_CONTACTS: Optional[List[str]] = ["ravirajsinhdabhi86@gmail.com", "https://www.linkedin.com/in/ravirajsinh45"]
